...
export function Login() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-b from-[#F8FBFC] via-[#F1F7F9] to-[#E6F0F4] flex items-center justify-center p-4 sm:p-6">
      <div className="max-w-md w-full bg-white rounded-3xl border border-slate-200 p-6 sm:p-10 shadow-xl shadow-slate-200/50">
        
        {/* Header */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-50 border border-blue-100 mb-3 shadow-xs">
            <Leaf className="w-8 h-8 text-[#0F4C81]" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 py-3.5 px-4 bg-[#0F4C81] hover:bg-[#1A6BB5] text-white font-bold text-sm rounded-xl transition-all shadow-md shadow-[#0F4C81]/20 active:scale-[0.99] flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
          >
        ...
        <button
          ...
          type="button"
          className="w-full py-3 px-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 transition flex items-center justify-center gap-3 cursor-pointer shadow-xs"
        >
